...
CREATE TABLE `detail_package` (
  `package_day_package_id` varchar(2) NOT NULL,
  `package_day_day` varchar(2) NOT NULL,
  `activity` varchar(2) NOT NULL,
  `activity_type` varchar(1) DEFAULT NULL,
  `id` varchar(2) DEFAULT NULL,
  `description` text,
  PRIMARY KEY (`package_day_package_id`,`package_day_day`,`activity`),
  KEY `fk_detail_package_package_day1_idx` (`package_day_package_id`,`package_day_day`),
  CONSTRAINT `fk_detail_package_package_day1` FOREIGN KEY (`package_day_package_id`, `package_day_day`) REFERENCES `package_day` (`package_id`, `day`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detail_service_package` (
  `service_package_id` varchar(2) NOT NULL,
  `package_id` varchar(2) NOT NULL,
  `status` varchar(2) NOT NULL,
  PRIMARY KEY (`service_package_id`,`package_id`),
  KEY `fk_detail_service_package_package1_idx` (`package_id`),
  CONSTRAINT `fk_detail_service_package_package1` FOREIGN KEY (`package_id`) REFERENCES `package` (`id`),
  CONSTRAINT `fk_detail_service_package_service_package` FOREIGN KEY (`service_package_id`) REFERENCES `service_package` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `homestay_gallery` (
  `id` varchar(2) NOT NULL,
  `homestay_id` varchar(2) NOT NULL,
  `url` text,
  PRIMARY KEY (`id`),
  KEY `fk_homestay_gallery_homestay1_idx` (`homestay_id`),
  CONSTRAINT `fk_homestay_gallery_homestay1` FOREIGN KEY (`homestay_id`) REFERENCES `homestay` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `package_day` (
  ...
  KEY `fk_package_day_package1_idx` (`package_id`),
  CONSTRAINT `fk_package_day_package1` FOREIGN KEY (`package_id`) REFERENCES `package` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'fauzanpiliang13@gmail.com','piliang13',NULL,NULL,NULL,'default.svg','$2y$10$QysUxU6DHFbQT0/wvUR.7O.wePPStPJWIwF5QU5kR9wIIA97yjqwe',NULL,NULL,NULL,NULL,NULL,NULL,1,0,'2023-07-24 15:56:31','2023-07-24 15:56:31',NULL);
...
-- Dump completed on 2023-08-29 14:59:35
